            ...
            <div className='flex'>
                ...
                <div className='mx-auto'>
                    ...
                    <form onSubmit={handleAddWriter} className='my-5'>
                        ...
                        <br />
                        <input type="text" placeholder="নাম লিখুন" name='name' className="input input-bordered input-accent w-full max-w-xs" />
                        ...
                        <br />
                        <input type="text" placeholder="লিংক দিন" name='photo' className="input input-bordered input-accent w-full max-w-xs" />
                        ...
                        <select className="select select-bordered w-full max-w-xs" name='category'>
                            <option disabled selected>পরিচিতি নির্বাচন করুন</option>
                        ...
                        <br />
                        <textarea className='border rounded py-2 px-2' placeholder="জীবন বৃত্তান্ত লিখুন" name="bio" id="" cols="60" rows="5"></textarea>
